...
| Path | Contents |
|------|----------|
| `AI-skills/` | Canonical skill instructions — `bin/ko-install-global-skills` installs thin user-level Claude/Codex wrappers that reference this directory through `$ORCHESTRA_DIR` |
